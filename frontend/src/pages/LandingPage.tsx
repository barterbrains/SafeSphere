...
function SafeSphereLogo({ size = 32 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 36 36" fill="none">
      <circle cx="18" cy="18" r="17" stroke="#2dd4bf" strokeWidth="1.5" strokeOpacity="0.3" />
      <path
        d="M18 8 C24 8, 28 12, 28 18 C28 24, 22 28, 16 26 C10 24, 8 18, 10 14 C12 10, 16 10, 18 12 C20 14, 20 17, 18 18 C16 19, 14 18, 14 16"
...
function SafeScoreRing({
  score = 88, size = 160, color = '#2dd4bf'
...
function PhoneMockup() {
  ...
  return (
    <div style={{
      width: 280, background: '#0d1520', borderRadius: 40,
      border: '2px solid rgba(45,212,191,0.25)', overflow: 'hidden',
      boxShadow: '0 0 60px rgba(45,212,191,0.2), 0 40px 80px rgba(0,0,0,0.7)',
      position: 'relative',
    }}>
      <div style={{ background: '#000', height: 28, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ width: 80, height: 16, background: '#0d1520', borderRadius: 10 }} />
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '20px 20px 12px' }}>
        <SafeScoreRing score={88} size={160} />
        <div style={{ marginTop: 12, textAlign: 'center' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 4, color: '#2dd4bf', fontSize: '0.75rem', fontWeight: 600 }}>
            <MapPin size={11} /><span>New York City</span>
          </div>
          <div style={{ color: '#475569', fontSize: '0.65rem', marginTop: 2 }}>1.3 miles · Now LIVE</div>
        </div>
      </div>
      <div style={{ margin: '0 14px', background: '#111827', borderRadius: 14, padding: '10px 14px', border: '1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ fontSize: '0.65rem', fontWeight: 700, color: '#475569', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 8 }}>Trusted Contacts</div>
        <div style={{ display: 'flex', justifyContent: 'space-around' }}>
          {contacts.map(c => (
            <div key={c.name} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
              <div style={{
                width: 36, height: 36, borderRadius: '50%',
                background: 'linear-gradient(135deg, #1e3a3a, #2dd4bf22)',
                border: '1.5px solid rgba(45,212,191,0.3)',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                fontSize: '0.7rem', fontWeight: 700, color: '#2dd4bf',
              }}>{c.initial}</div>
              <span style={{ fontSize: '0.6rem', color: '#94a3b8' }}>{c.name}</span>
              <span style={{ fontSize: '0.55rem', color: '#2dd4bf' }}>{c.status}</span>
            </div>
          ))}
        </div>
      </div>
...
function FaqItem({ q, a }: { q: string; a: string }) {
  ...
  return (
    <div style={{
      ...
      >
        <span>{q}</span>
        <ChevronDown size={18} color="#2dd4bf" style={{ flexShrink: 0, transform: open ? 'rotate(180deg)' : 'none', transition: 'transform 0.2s' }} />
      </button>
      {open && (
...
export default function LandingPage() {
  ...
  const features = [
    {
      icon: <Navigation2 size={20} color="#2dd4bf" />,
    ...
    {
      icon: <Bell size={20} color="#2dd4bf" />,
    ...
    {
      icon: <Users size={20} color="#2dd4bf" />,
  ...
  const steps = [
    ...
    },
    {
      ...
      icon: <BarChart2 size={22} color="#2dd4bf" />,
    },
    {
      num: '03',
      ...
      icon: <Users size={22} color="#2dd4bf" />,
    },
    {
      num: '04',
  ...
  const scoreExamples = [
    {
      score: 85, color: '#2dd4bf', label: 'Very Safe', labelColor: '#2dd4bf',
  ...
  return (
    <div style={{ background: '#0B0F17', minHeight: '100vh', fontFamily: "'Inter', sans-serif", color: '#F1F5F9', overflowX: 'hidden' }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <SafeSphereLogo size={32} />
          <span style={{ fontSize: '1.15rem', fontWeight: 800, letterSpacing: '-0.02em' }}>SafeSphere</span>
        </div>
        ...
        <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
          <button onClick={() => navigate('/login')} style={{ background: 'none', border: 'none', color: '#94a3b8', fontSize: '0.88rem', fontWeight: 500, cursor: 'pointer', padding: '8px 12px', fontFamily: 'inherit' }}>Log In</button>
          <button onClick={handleDemoLogin} style={{
            background: '#2dd4bf', border: 'none', borderRadius: 999, padding: '9px 20px',
            color: '#042220', fontWeight: 700, fontSize: '0.88rem', cursor: 'pointer', fontFamily: 'inherit',
            boxShadow: '0 0 20px rgba(45,212,191,0.4)', transition: 'opacity 0.15s, transform 0.15s',
          }}
        ...
        <div style={{ maxWidth: 1180, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 60, alignItems: 'center', position: 'relative', zIndex: 1 }}>
          ...
          <div>
            <div style={{
              ...
              background: 'rgba(45,212,191,0.08)', padding: '5px 12px',
              borderRadius: 999, border: '1px solid rgba(45,212,191,0.2)',
              marginBottom: 24, fontSize: '0.75rem', fontWeight: 600,
            ...
            <h1 style={{ fontSize: 'clamp(2.4rem, 5vw, 3.6rem)', fontWeight: 900, lineHeight: 1.1, letterSpacing: '-0.03em', marginBottom: 20 }}>
              ...
              <span style={{ color: '#2dd4bf' }}>intelligence.</span>
            </h1>
            ...
            <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap', marginBottom: 48 }}>
              <button onClick={() => navigate('/register')} style={{
                background: '#2dd4bf', border: 'none', borderRadius: 999, padding: '13px 28px',
                color: '#042220', fontWeight: 700, fontSize: '0.95rem', cursor: 'pointer', fontFamily: 'inherit',
                boxShadow: '0 0 28px rgba(45,212,191,0.45)', transition: 'opacity 0.15s, transform 0.15s',
              }}
              ...
              <button onClick={handleDemoLogin} style={{
                ...
                borderRadius: 999, padding: '13px 24px', color: '#f1f5f9', fontWeight: 600,
            ...
            <div style={{
              ...
              <div style={{ width: 28, height: 28, borderRadius: 8, background: 'rgba(45,212,191,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Shield size={14} color="#2dd4bf" />
              </div>
              <div>
                <div style={{ fontSize: '0.72rem', color: '#2dd4bf', fontWeight: 700 }}>System Status</div>
                <div style={{ fontSize: '0.67rem', color: '#94a3b8' }}>Secure</div>
              </div>
            </div>
          </div>
          {/* Right */}
      ...
      {/* ═══ CAPABILITIES BAR ═════════════════════════════════════════════ */}
      <section style={{ borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)', background: 'rgba(255,255,255,0.02)', padding: '36px 6%' }}>
        <div style={{ maxWidth: 1180, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 0 }}>
          {capabilities.map((s, i) => (
            <div key={s.label} style={{
              ...
              <div style={{ fontSize: 'clamp(1.8rem, 3vw, 2.4rem)', fontWeight: 900, color: '#2dd4bf', letterSpacing: '-0.03em', lineHeight: 1 }}>{s.num}</div>
      ...
      <section id="how-it-works" style={{ padding: '100px 6%', scrollMarginTop: 80 }}>
        <div style={{ maxWidth: 1180, margin: '0 auto' }}>
          <div style={{ marginBottom: 64 }}>
            <div style={{ fontSize: '0.75rem', fontWeight: 700, color: '#2dd4bf', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 12 }}>How It Works</div>
              ...
              <div key={step.num} style={{ position: 'relative', paddingRight: 32 }}>
                ...
                {i < steps.length - 1 && (
                  <div style={{
                    ...
                    background: 'linear-gradient(90deg, rgba(45,212,191,0.3) 0%, rgba(45,212,191,0.05) 100%)',
                    display: 'block',
                  }} />
                )}
                <div style={{ marginBottom: 20, display: 'flex', alignItems: 'center', gap: 12 }}>
                  ...
                  <span style={{ fontSize: '0.7rem', fontWeight: 800, color: 'rgba(45,212,191,0.4)', letterSpacing: '0.06em' }}>{step.num}</span>
                </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 20 }}>
            {features.map(f => (
              <div key={f.label} style={{
                ...
                borderRadius: 16, padding: '28px 24px', transition: 'border-color 0.2s, background 0.2s',
                display: 'flex', flexDirection: 'column',
              }}
                onMouseEnter={e => { const el = e.currentTarget as HTMLDivElement; el.style.borderColor = 'rgba(45,212,191,0.25)'; el.style.background = 'rgba(45,212,191,0.04)'; }}
              ...
              >
                ...
                <div style={{
                  ...
                  fontSize: '0.78rem', color: '#2dd4bf', fontWeight: 600,
                }}>{f.stat}</div>
                <button style={{
                  marginTop: 12, background: 'none', border: 'none', color: '#475569',
      ...
      <section id="safescore" style={{ padding: '100px 6%', scrollMarginTop: 80 }}>
        <div style={{ maxWidth: 1180, margin: '0 auto' }}>
          <div style={{ marginBottom: 56 }}>
            <div style={{ fontSize: '0.75rem', fontWeight: 700, color: '#2dd4bf', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 12 }}>The SafeScore Engine</div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 24 }}>
            {scoreExamples.map(ex => (
              <div key={ex.label} style={{
                background: '#0d1520', border: `1px solid ${ex.color}22`,
      ...
      {/* ═══ TESTIMONIALS ════════════════════════════════════════════════ */}
      <section style={{ padding: '80px 6%', background: 'rgba(255,255,255,0.015)', borderTop: '1px solid rgba(255,255,255,0.04)' }}>
        <div style={{ maxWidth: 1180, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 20 }}>
            {testimonials.map((t, i) => (
              <div key={t.name} style={{
                background: i === 1 ? 'rgba(45,212,191,0.04)' : 'rgba(255,255,255,0.025)',
                border: i === 1 ? '1px solid rgba(45,212,191,0.18)' : '1px solid rgba(255,255,255,0.06)',
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <div style={{
                    ...
                    background: 'linear-gradient(135deg, #1e3a3a, #2dd4bf33)',
                    border: '1.5px solid rgba(45,212,191,0.3)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    fontSize: '0.85rem', fontWeight: 700, color: '#2dd4bf', flexShrink: 0,
                  }}>{t.initial}</div>
                  <div>
      ...
      <section style={{ padding: '100px 6%' }}>
        <div style={{ maxWidth: 1180, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 60, alignItems: 'center' }}>
          <div>
            <div style={{ fontSize: '0.75rem', fontWeight: 700, color: '#2dd4bf', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 14 }}>Enterprise & Campus</div>
            ...
            <button onClick={() => navigate('/institution/login')} style={{
              ...
              borderRadius: 999, padding: '11px 28px', color: '#2dd4bf',
              fontWeight: 700, fontSize: '0.9rem', cursor: 'pointer', fontFamily: 'inherit',
              transition: 'background 0.15s, border-color 0.15s',
            }}
              onMouseEnter={e => { e.currentTarget.style.background = 'rgba(45,212,191,0.08)'; e.currentTarget.style.borderColor = 'rgba(45,212,191,0.7)'; }}
              onMouseLeave={e => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.borderColor = 'rgba(45,212,191,0.4)'; }}
            >Request Institutional Access</button>
          </div>

          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {[
              { icon: <Map size={18} color="#2dd4bf" />, title: 'Aggregated Incident Heatmaps', desc: 'Visualise SafeScore distributions and incident clusters across your campus perimeter, updated daily.' },
              { icon: <BarChart2 size={18} color="#2dd4bf" />, title: 'Fleet-Wide SafeScore Analytics', desc: 'Track how route safety evolves over time for your entire user cohort. Justify infrastructure spend with data.' },
              { icon: <Lock size={18} color="#2dd4bf" />, title: 'SSO & Admin Dashboard Access', desc: 'Single Sign-On integration, role-based admin controls, and a dedicated security command centre.' },
            ].map(item => (
              <div key={item.title} style={{
                ...
                <div style={{ width: 36, height: 36, borderRadius: 8, background: 'rgba(45,212,191,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                  {item.icon}
                </div>
                <div>
      ...
      <footer style={{ borderTop: '1px solid rgba(255,255,255,0.05)', padding: '48px 6% 32px' }}>
        <div style={{ maxWidth: 1180, margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr 1fr', gap: 48, marginBottom: 40 }}>
            <div style={{ maxWidth: 220 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
                <SafeSphereLogo size={26} />
                <span style={{ fontWeight: 800, fontSize: '1rem' }}>SafeSphere</span>
              </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {['Privacy Policy', 'Terms of Service', 'Contact'].map(l => (
                <button key={l} style={{ background: 'none', border: 'none', color: '#475569', fontSize: '0.85rem', cursor: 'pointer', textAlign: 'left', fontFamily: 'inherit', padding: 0, transition: 'color 0.15s' }}
                  onMouseEnter={e => (e.currentTarget.style.color = '#2dd4bf')}
                  onMouseLeave={e => (e.currentTarget.style.color = '#475569')}
                >{l}</button>
              ))}
          ...
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.04)', paddingTop: 20, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 8 }}>
            <span style={{ fontSize: '0.78rem', color: '#334155' }}>© 2024 SafeSphere. Protective Sophistication.</span>
            <div style={{ display: 'flex', gap: 16 }}>
              {[
                ...
                <a key={s.label} href={s.href} style={{ fontSize: '0.78rem', color: '#334155', textDecoration: 'none', transition: 'color 0.15s' }}
                  onMouseEnter={e => (e.currentTarget.style.color = '#2dd4bf')}
