...
export default function InstitutionLoginPage() {
  ...
  const handleInstantDemoLogin = () => {
    ...
    setAuth('inst-token-verified', {
      id: 'gtbit-inst-admin',
      name: 'Command Administrator',
      email: 'admin@gtbit.edu.in',
      role: 'institution',
      organization: 'GTBIT Campus Operations',
    });
    setTimeout(() => {
      setLoading(false);
  ...
  const handleVerifyMfa = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      // Set authenticated institutional context
      setInstitutionDemoMode();
      setAuth('inst-token-verified', {
        id: 'gtbit-inst-admin',
        name: 'Command Administrator',
            ...
            <div className="flex flex-col gap-5 animate-in fade-in duration-300">
              ...
              <div className="bg-indigo-500/10 border border-indigo-500/30 rounded-xl p-3 text-[12px] text-indigo-300 flex items-center justify-between gap-2">
                <div className="flex items-center gap-2">
                  ...
                  <span>Demo MFA Key active (<strong>782490</strong>)</span>
                </div>
                <button
                  type="button"
